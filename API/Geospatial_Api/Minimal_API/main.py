...
# While geodesic calculates great circle distance between two coordinates
# Line 4 - allows me to manually control the response very useful when returning errors on no 200 statuses
...
# HOW
# This API can be used by a mobile app to show users how far they are from my base or office.
...
# Again have interest in calculating distance from users location to saloon.
# Now for abit more when giving you proximity as it icludes time to along intergrating traffic, routes choosing.
# Using it as a notification for the likes of USave or new saloong added to Db
# Then scale it to  accomodate more devices connected.
